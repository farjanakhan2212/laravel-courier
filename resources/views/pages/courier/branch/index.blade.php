...
<tr>
    ...
    <td class="d-flex justify-content-center">
      <div class="btn-group">
        <a class="btn btn-primary" href="{{url('branches/'.$branch->id)}}">View</a>
        <a class="btn btn-danger" href="{{url('branches/'.$branch->id.'/delete')}}">Delete</a>
        <a class="btn btn-success" href="{{url('branches/'.$branch->id.'/edit')}}">Edit</a>
      </div>
    </td>
</tr>
@endforeach
