...
<div class="card">
  <div class="card-header">
    <div class="row flex-between-center">
      <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
        <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Create Person</h5>
      </div>
  ...
  <div class="card-body">
    ...
    <form action="{{url('persons')}}" method="post" enctype="multipart/form-data">
      @csrf
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="doj" name="doj" type="text">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="inactive" name="inactive" type="text">
        </div>
      </div>
