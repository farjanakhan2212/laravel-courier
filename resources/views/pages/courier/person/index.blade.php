...
<tr>
    ...
    <td class="d-flex justify-content-center">
      <div class="btn-group">
        <a class="btn btn-primary" href="{{url('persons/'.$person->id)}}">View</a>
        <a class="btn btn-danger" href="{{url('persons/'.$person->id.'/delete')}}">Delete</a>
        <a class="btn btn-success" href="{{url('persons/'.$person->id.'/edit')}}">Edit</a>
      </div>
    </td>
</tr>
@endforeach
