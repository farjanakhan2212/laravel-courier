...
<div class="card">
    <div class="card-header">
       <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                  <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Person Details</h5>
                </div>                
   ...
   <table class="table table-bordered table-striped">
    <tr><th>Id</th><td> {{$person->id}}</td></tr>
      ...
      <tr><th>Position_id</th><td> {{$person->position_id}}</td></tr>
      <tr><th>Sex</th><td> {{$person->sex}}</td></tr>
      <tr><th>DOB</th><td> {{$person->dob}}</td></tr>
      <tr><th>DOJ</th><td> {{$person->doj}}</td></tr>
      <tr><th>Mobile</th><td> {{$person->mobile}}</td></tr>
      <tr><th>Address</th><td> {{$person->address}}</td></tr>
      <tr><th>Inactive</th><td> {{$person->inactive}}</td></tr>
