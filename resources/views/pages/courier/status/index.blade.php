    ...
    <div class="card-header">
       <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                  <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Status List</h5>
                </div>
...
<tr>
    ...
    <td class="d-flex justify-content-center">
      <div class="btn-group">
        <a class="btn btn-primary" href="{{url('statuses/'.$status->id)}}">View</a>
        <a class="btn btn-danger" href="{{url('statuses/'.$status->id.'/delete')}}">Delete</a>
        <a class="btn btn-success" href="{{url('statuses/'.$status->id.'/edit')}}">Edit</a>
      </div>
    </td>
</tr>
@endforeach
