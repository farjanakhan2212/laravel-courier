...
<div class="card">
    <div class="card-header">
       <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                  <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Shipment Details</h5>
                </div>
   ...
   <table class="table table-bordered table-striped">
      <tr><th>Id</th><td> {{$shipment->id}}</td></tr>
      <tr><th>Name</th><td> {{$shipment->name}}</td></tr>      
     
      <tr>
        <td>
          <form action="{{url('shipments/'.$shipment->id)}}" method="post">
          @csrf
          @method("DELETE")          
