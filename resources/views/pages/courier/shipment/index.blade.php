...
<tr>
    ...
    <td class="d-flex justify-content-center">
      <div class="btn-group">
        <a class="btn btn-primary" href="{{url('shipments/'.$shipment->id)}}">View</a>
        <a class="btn btn-danger" href="{{url('shipments/'.$shipment->id.'/delete')}}">Delete</a>
        <a class="btn btn-success" href="{{url('shipments/'.$shipment->id.'/edit')}}">Edit</a>
      </div>
    </td>
</tr>
@endforeach
