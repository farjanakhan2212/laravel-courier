  ...
  <div class="card-header">
    <div class="row flex-between-center">
      <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
        <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">History by Date</h5>
      </div>
  ...
  <div class="card-body">
    ...
    <form action="{{url('history')}}" method="post" enctype="multipart/form-data">
      @csrf
       ...
       <div class="row mb-3">
        <label class="col-sm-2 col-form-label" for="parcel_id">Parcel</label>
        <div class="col-sm-10">
    ...
    <div class="row mb-3">
        <label class="col-sm-2 col-form-label" for="branch_id">Person</label>
        <div class="col-sm-10">
