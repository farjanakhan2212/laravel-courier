...
<div class="card">
    <div class="card-header">
       <div class="row flex-between-center">
                <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                  <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">History Details</h5>
                </div>
   ...
   <table class="table table-bordered table-striped">
      <tr><th>Id</th><td> {{$history->id}}</td></tr>
      <tr><th>Parcel_id</th><td> {{$history->parcel_id}}</td></tr>      
      <tr><th>Status_id</th><td> {{$history->status_id}}</td></tr>      
      <tr><th>Person_ID</th><td> {{$history->person_id}}</td></tr>      
      <tr><th>Branch_ID</th><td> {{$history->branch_id}}</td></tr>      
      <tr><th>Created_At</th><td> {{$history->created_at}}</td></tr>
      <tr><th>Remark</th><td> {{$history->remark}}</td></tr>
