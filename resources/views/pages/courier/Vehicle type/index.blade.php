...
<tr>
    ...
    <td class="d-flex justify-content-center">
      <div class="btn-group">
        <a class="btn btn-primary" href="{{url('vehicletypes/'.$vehicletype->id)}}">View</a>
        <a class="btn btn-danger" href="{{url('vehicletypes/'.$vehicletype->id.'/delete')}}">Delete</a>
        <a class="btn btn-success" href="{{url('vehicletypes/'.$vehicletype->id.'/edit')}}">Edit</a>
      </div>
    </td>
</tr>
@endforeach
