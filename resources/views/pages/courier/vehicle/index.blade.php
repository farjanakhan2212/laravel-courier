...
<tr>
    ...
    <td class="d-flex justify-content-center">
      <div class="btn-group">
        <a class="btn btn-primary" href="{{url('vehicles/'.$vehicle->id)}}">View</a>
        <a class="btn btn-danger" href="{{url('vehicles/'.$vehicle->id.'/delete')}}">Delete</a>
        <a class="btn btn-success" href="{{url('vehicles/'.$vehicle->id.'/edit')}}">Edit</a>
      </div>
    </td>
</tr>
@endforeach
