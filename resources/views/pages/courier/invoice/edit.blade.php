  ...
  <div class="card-header">
    <div class="row flex-between-center">
      <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
        <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Edit Invoice</h5>
      </div>
  ...
  <div class="card-body">
    ...
    <form action="{{url('invoices/'.$invoice->id)}}" method="post" enctype="multipart/form-data">
      ...
      @method("PUT")
          ...
          <div class="row mb-3">
        <label class="col-sm-2 col-form-label" for="sender_id">Sender ID</label>
        <div class="col-sm-10">
          <input class="form-control" id="sender_id" name="sender_id" type="text" value="{{ $invoice->sender_id }}">
        </div>
      </div>
       ...
       <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="remark" name="remark" type="text" value="{{ $invoice->remark }}">
        </div>
      </div>

       <div class="row mb-3">
        <label class="col-sm-2 col-form-label" for="payment_term">Payment Term</label>
        <div class="col-sm-10">
          <input class="form-control" id="payment_term" name="payment_term" type="text" value="{{ $invoice->payment_term }}">
        </div>
      </div>

      
       <div class="row mb-3">
        <label class="col-sm-2 col-form-label" for="invoice_total">Invoice Total</label>
        <div class="col-sm-10">
          <input class="form-control" id="invoice_total" name="invoice_total" type="text" value="{{ $invoice->invoice_total }}">
        </div>
      </div>

      
       <div class="row mb-3">
        <label class="col-sm-2 col-form-label" for="paid_total">Paid Total</label>
        <div class="col-sm-10">
          <input class="form-control" id="paid_total" name="paid_total" type="text" value="{{ $invoice->paid_total }}">
        </div>
      </div>
