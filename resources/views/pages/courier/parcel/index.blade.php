...
<tr>
    ...
    <td class="d-flex justify-content-center">
      <div class="btn-group">
        <a class="btn btn-primary" href="{{url('parcels/'.$parcel->id)}}">View</a>
        <a class="btn btn-danger" href="{{url('parcels/'.$parcel->id.'/delete')}}">Delete</a>
        <a class="btn btn-success" href="{{url('parcels/'.$parcel->id.'/edit')}}">Edit</a>
