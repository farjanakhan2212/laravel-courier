...
<div class="card">
  <div class="card-header">
    <div class="row flex-between-center">
      <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
        <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Edit Parcel</h5>
      </div>
  ...
  <div class="card-body">
    ...
    <form action="{{url('parcels/'.$parcel->id)}}" method="post" enctype="multipart/form-data">
      @csrf
      @method("PUT")
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="remark" name="remark" type="text" value="{{ $parcel->remark }}">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="weight" name="weight" type="text" value="{{ $parcel->weight }}">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="created_at" name="created_at" type="datetime-local" value="{{ $parcel->created_at }}">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="update_at" name="update_at" type="datetime-local" value="{{ $parcel->update_at }}">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="is_csc" name="is_csc" type="text" value="{{ $parcel->is_csc }}">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="price" name="price" type="text" value="{{ $parcel->price }}">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="paid_amount" name="paid_amount" type="text" value="{{ $parcel->paid_amount }}">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input class="form-control" id="vat" name="vat" type="text" value="{{ $parcel->vat }}">
        </div>
      </div>
...
<script>
  var base_url = "http://127.0.0.1:8000/api/courier";

  async function loadSection() {

    let id = document.querySelector("#type_id").value;
