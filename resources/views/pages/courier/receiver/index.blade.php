...
<tr>
    ...
    <td class="d-flex justify-content-center">
      <div class="btn-group">
        <a class="btn btn-primary" href="{{url('receivers/'.$receiver->id)}}">View</a>
        <a class="btn btn-danger" href="{{url('receivers/'.$receiver->id.'/delete')}}">Delete</a>
        <a class="btn btn-success" href="{{url('receivers/'.$receiver->id.'/edit')}}">Edit</a>
      </div>
    </td>
</tr>
@endforeach
