...
<tr>
    ...
    <td class="d-flex justify-content-center">
      <div class="btn-group">
        <a class="btn btn-primary" href="{{url('types/'.$type->id)}}">View</a>
        <a class="btn btn-danger" href="{{url('types/'.$type->id.'/delete')}}">Delete</a>
        <a class="btn btn-success" href="{{url('types/'.$type->id.'/edit')}}">Edit</a>
      </div>
    </td>
</tr>
@endforeach
