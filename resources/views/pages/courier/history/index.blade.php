...
<tr>
    ...
    <td>{{$history->parcel_id}}</td>
    <td>{{$history->status_id}}</td>
    <td>{{$history->remark}}</td>
    <td>{{$history->person_id}}</td>
    <td>{{$history->branch_id}}</td>
    <td>{{$history->created_at}}</td>
 
    <td class="d-flex justify-content-center">
      <div class="btn-group">
        <a class="btn btn-primary" href="{{url('history/'.$history->id)}}">View</a>
        <a class="btn btn-danger" href="{{url('history/'.$history->id.'/delete')}}">Delete</a>
        <a class="btn btn-success" href="{{url('history/'.$history->id.'/edit')}}">Edit</a>
      </div>
    </td>
</tr>
@endforeach
